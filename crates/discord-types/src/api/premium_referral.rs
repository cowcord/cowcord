...
use crate::common::id::{PremiumReferralId, TrialId, UserId};
use crate::common::timestamp::Timestamp;

#[derive(Serialize, Deserialize)]
pub struct PremiumReferral {
	/// The ID of the referral
	pub id: PremiumReferralId,
...
pub struct PremiumReferralEligibility {
	...
	pub referrals_remaining: u16,
	/// The IDs of users that have been referred
	pub sent_user_ids: Vec<UserId>,
	...
	pub recipient_status: HashMap<UserId, PremiumReferralRecipientStatus>,
