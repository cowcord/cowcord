use discord_types::API_VERSION;
use discord_types::api::endpoints::websocket::{WEBSOCKET, WebSocketQueryParams};
use discord_types::api::websocket::GatewayEncoding;
use wasm_bindgen::prelude::*;
use web_sys::{ErrorEvent, MessageEvent, WebSocket};

const QUERY: WebSocketQueryParams = WebSocketQueryParams {
	v: API_VERSION::v9,
