...
pub mod as_str {
	...
	use crate::de::str::HexDeserialize;
	use crate::ser::str::HexSerialize;
...
pub mod as_num {
	...
	use crate::de::num::HexDeserialize;
	use crate::ser::num::HexSerialize;
