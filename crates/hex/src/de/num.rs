		...
		D: Deserializer<'de>,
	{
		...
		impl<'de> Visitor<'de> for HexVisitor {
			...
			fn expecting(
				...
				formatter.write_str("a u64 number")
			}
		...
		deserializer.deserialize_u64(HexVisitor)
	}
}
		...
		D: Deserializer<'de>,
	{
			...
			T: HexDeserialize<'de>,
		{
			...
			fn expecting(
				...
				formatter.write_str("an optional u64 number")
			}
		...
		D: Deserializer<'de>,
	{
		...
		impl<'de> Visitor<'de> for VecHexVisitor {
			...
			fn expecting(
				...
				formatter.write_str("a list of u64 numbers")
			}
		...
		D: Deserializer<'de>,
	{
		...
		impl<'de> Visitor<'de> for TupleHexVisitor {
			...
			fn expecting(
				...
				formatter.write_str("a tuple of two u64 numbers")
			}
